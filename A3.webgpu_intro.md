...
The goal of this assignment is to move away everything The Schwartz provides and get comfortable
using HTML/JavaScript in conjunction with shaders before we begin doing our simulation work. We'll also
have some fun with live video processing along the way. We'll use [gulls.js](https://codeberg.org/charlieroberts/gulls) 
as an abstraction wrapping WebGPU, and (optionally, depending on your interests) get into the nitty gritty details of WebGPU 
progamming later in the course.

- Create an interactive piece that runs in a HTML page hosted at site of your choosing (GitHub Pages is fine for this, you could also consider something like [codepen](https://codepen.io)). The best starting point for this assignment is probably the
[video feedback howto from gulls](https://codeberg.org/charlieroberts/gulls/src/branch/main/howtos/9_video_feedback)). The piece should feature a fullscreen fragment shader with the following features:

  - The piece should incorporate live video in some way.
  ...
  - The piece should feature at least four different interaction mechanisms. This might include using the mouse / touch, regular HTML form elements, or widgets from a library like [TweakPane](https://cocopon.github.io/tweakpane/) 
